...
//	キー入力(１回判定)簡易マクロ
#define DX_ONEINPUT_KEYUP()					dxLib_KeyInputOneCheck( ::lDxKey::KEYINPUT_KEYUP )
#define DX_ONEINPUT_KEYDOWN()				dxLib_KeyInputOneCheck( ::lDxKey::KEYINPUT_KEYDOWN )
#define DX_ONEINPUT_KEYLEFT()				dxLib_KeyInputOneCheck( ::lDxKey::KEYINPUT_KEYLEFT )
#define DX_ONEINPUT_KEYRIGHT()				dxLib_KeyInputOneCheck( ::lDxKey::KEYINPUT_KEYRIGHT )
#define DX_ONEINPUT_ENTER()					dxLib_KeyInputOneCheck( ::lDxKey::KEYINPUT_ENTER )
#define DX_ONEINPUT_CANCEL()					dxLib_KeyInputOneCheck( ::lDxKey::KEYINPUT_CANCEL )

//	キー入力(押しっぱなし判定)簡易マクロ
#define DX_DIRECTINPUT_ENTER()				dxLib_KeyInputDirectCheck( ::lDxKey::KEYINPUT_ENTER )
#define DX_DIRECTINPUT_CANCEL()			dxLib_KeyInputDirectCheck( ::lDxKey::KEYINPUT_CANCEL )
