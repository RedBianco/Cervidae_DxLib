...
// タスクシステムの初期化
//=================================================================================//
void	App::TaskManager::TaskSystem_Initialize(
	STaskSystemInfo* TSysInfo		// タスクシステム情報構造体のアドレス
)
{
	// 構造体全体をゼロ初期化する
	...
	DEBUG_PRINT("[Task] App::TaskManager::TaskSystem_Initialize()\n");
}
//=================================================================================//
// タスクシステムの後始末
//=================================================================================//
void	App::TaskManager::TaskSystem_Terminate(
	STaskSystemInfo* TSysInfo		// タスクシステム情報構造体のアドレス
)
{
	STaskInfo *TInfo;
...
bool	App::TaskManager::TaskSystem_Step(
	STaskSystemInfo* TSysInfo,		// タスクシステム情報構造体のアドレス
...
//=================================================================================//
// タスクシステムの描画処理を実行する
void	App::TaskManager::TaskSystem_Render(
	STaskSystemInfo* TSysInfo		// タスクシステム情報構造体のアドレス
)
{
	STaskInfo *TInfo;
...
//=================================================================================//
// タスクシステムにタスクを追加する
void	App::TaskManager::TaskSystem_AddTask(
	STaskSystemInfo* TSysInfo,		// タスクシステム情報構造体のアドレス
...
void	App::TaskManager::TaskSystem_DelTask(
	STaskSystemInfo* TSysInfo,		// タスクシステム情報構造体のアドレス
